...
import { RealTimeTradingProvider } from "@/contexts/real-time-trading-context";
...
export default function DashboardLayout({
  ...
  return (
    <RealTimeTradingProvider>
      <div className="min-h-screen bg-gray-950 text-white">
        <div className="flex">
          {/* Sidebar */}
          <DashboardSidebar isCollapsed={sidebarCollapsed} onToggle={toggleSidebar} />
          ...
          <div className="flex-1 flex flex-col h-screen overflow-hidden">
            ...
            <main className="flex-1 overflow-y-auto bg-gray-950">
              <div className={`${sidebarCollapsed ? 'p-4' : 'p-6'} transition-all duration-300`}>
                {children}
              </div>
            </main>
          </div>
